...
public class EulerAngles {
	...
	public final void set(Matrix3x3 M) {
		...
		if(Math.abs(M.e22() - 1d) < 1e-5d || M.e22() > 1d) {
			...
			phi1 = SaferMath.atan2(M.e01(), M.e00());
			Phi = 0d;
			phi2 = 0d;
			...
			phi1 = SaferMath.atan2(M.e20(), -M.e21());
			Phi = SaferMath.acos(M.e22());
			phi2 = SaferMath.atan2(M.e02(), M.e12());
		}				
	}
	...
	public final void set(Quaternion Q) {
		...
		Phi = SaferMath.acos(Q.q0()*Q.q0() + Q.q3()*Q.q3() - (Q.q1()*Q.q1() + Q.q2()*Q.q2()) );
		
		if(Math.abs(Phi) < 1e-5d) {
			
			phi1 = SaferMath.atan2(-2d * Q.q0() * Q.q3(), Q.q0()*Q.q0() - Q.q3()*Q.q3());
			phi2 = 0d;
			
			
		} else if(Math.abs(Phi - Math.PI) < 1e-5d) {
			
			phi1 = SaferMath.atan2(2d * Q.q1() * Q.q2(), Q.q1()*Q.q1() - Q.q2()*Q.q2());
			phi2 = 0d;
			...
			phi1 = SaferMath.atan2(-q02 + q13, -(q23 + q01));
			phi2 = SaferMath.atan2(q13 + q02, q23 - q01);
		}
